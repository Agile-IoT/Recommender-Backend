...
<div class="recomWindowFirst">
	<p> <strong>${devname1}</strong> <a href="${devhref1}">Order Device</a> <br/> 
	${exp1}</p>
</div>
<div class="recomWindow">
	<p> <strong>${devname2}</strong> <a href="${devhref2}">Order Device</a> <br/> 
	${exp2}</p>
</div>
<div class="recomWindow">
	<p> <strong>${devname3}</strong> <a href="${devhref3}">Order Device</a> <br/> 
	${exp3}</p>
</div>
<div class="recomWindow">
	<p> <strong>${devname4}</strong> <a href="${devhref4}">Order Device</a> <br/> 
	${exp4}</p>
</div>
<div class="recomWindow">
	<p> <strong>${devname5}</strong> <a href="${devhref5}">Order Device</a> <br/> 
	${exp5}</p>
</div>
